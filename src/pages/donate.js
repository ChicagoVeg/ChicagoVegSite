      ...
      <article className="page">
        ...
        <div className="donate-area">
          <div className="donate-message">
            Thank you very much for your consideration. Donations are necessary
            to pay for website fees, name tags, signs, renting equipment,
            promotional materials, etc. If you wish to make in-kind donations
            that could be used as prizes to make our events more exciting or
