  ...
  <Layout>
    ...
    <section>
      <article className="page">
        <h2>Billboard</h2>
        <img className="text-wrap-image page-main-image" src={require('../images/MIWhyLoveButEatBillboard.jpg')} alt="change billboard" />
        <div>
          <p className="">
            The purpose of our billboard project is to publicly promote a
            plant-based diet.
          </p>
          <p className="">
            The billboard will encourage THOUSANDS of people to daily question
          ...
          <div className="">
            ...
            <ul>
              <li>
                <span className="bold">By donating:</span> Regardless if it's just
                $1 or $1000, any amount will bring us closer to our goal of
                $6,000.{" "}
                <a
              ...
              <li>
                ...
                Facebook, Twitter, Instagram, or any other ways to spread the
                word!
              </li>
              <li>
                <span className="bold"> By your time/effort:</span> Join our
                volunteering meeting at{" "}
          ...
          <p>
            ChicagoVeg is a registered 501c3 non-profit organization - Your
            donation can be tax deductible.
          </p>
